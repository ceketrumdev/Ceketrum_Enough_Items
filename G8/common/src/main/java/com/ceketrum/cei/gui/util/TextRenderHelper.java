...
public class TextRenderHelper {
     ...
     */
    public static int drawWrappedText(GuiGraphicsExtractor context, String text, int x, int y, int maxWidth, int color, float scale, int indent, Font textRenderer) {
        ...
        for (int p = 0; p < paragraphs.length; p++) {
            ...
            for (String word : words) {
                ...
                if (testWidth > maxWidth && currentLine.length() > 0) {
                    ...
                    context.text(textRenderer, Component.literal(currentLine.toString()), (int)(currentX * invScale), (int)(currentY * invScale), color, false);
