...
public class ClientRecipeHelper {
    ...
    private static RecipeHolder<?> wrapDisplayEntry(RecipeDisplayEntry entry) {
        Recipe mockRecipe = new Recipe() {
            ...
            @Override
            public ItemStack assemble(RecipeInput input) { return ItemStack.EMPTY; }
            @Override
        ...
        Identifier id = Identifier.fromNamespaceAndPath("cei_client_recipe", "recipe_" + entry.id().index());
