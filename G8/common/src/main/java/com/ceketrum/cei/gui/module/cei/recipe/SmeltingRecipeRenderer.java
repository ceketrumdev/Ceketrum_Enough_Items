...
public class SmeltingRecipeRenderer implements IRecipeRenderer {
    ...
    public int render(GuiGraphicsExtractor context, int startX, int startY,
        ...
        context.text(textRenderer, Component.translatable("recipe.cei.cooking.header"), 
     ...
     */
    private int drawCookingArrowBlock(GuiGraphicsExtractor context, int startX, int startY, 
        ...
        context.item(output, arrowStartX + arrowLength + arrowHeadSize + 6, startY); // Espacement de 6 pixels après la flèche
