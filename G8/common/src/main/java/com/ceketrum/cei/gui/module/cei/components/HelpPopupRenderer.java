...
public class HelpPopupRenderer {
    ...
    public void render(GuiGraphicsExtractor context, int screenWidth, int screenHeight, 
        ...
        context.outline(popupX, popupY, POPUP_WIDTH, POPUP_HEIGHT, borderColor);
        ...
        context.text(textRenderer, Component.literal(title).withStyle(ChatFormatting.BOLD), 
        ...
        context.text(textRenderer, Component.literal(helpText), textX, textY, textColor, false);
        if (!helpText2.isEmpty()) {
            textX = popupX + (POPUP_WIDTH - textRenderer.width(helpText2)) / 2;
            context.text(textRenderer, Component.literal(helpText2), textX, textY + 12, textColor, false);
        }
        ...
        context.text(textRenderer, Component.literal(closeSymbol), symbolX, symbolY, textColor, false);
    }
