...
public class RecipePopupRenderer {
    ...
    public ItemStats getItemStats(ItemStack stack) {
        ...
        // Attributes
        net.minecraft.component.type.AttributeModifiersComponent attributeComponent = stack.get(net.minecraft.component.DataComponentTypes.ATTRIBUTE_MODIFIERS);
        if (attributeComponent != null) {
            for (net.minecraft.component.type.AttributeModifiersComponent.Entry entry : attributeComponent.modifiers()) {
