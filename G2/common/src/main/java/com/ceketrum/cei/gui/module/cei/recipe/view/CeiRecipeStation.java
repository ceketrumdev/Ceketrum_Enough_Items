...
public final class CeiRecipeStation {
    ...
    public static synchronized String labelFor(Identifier typeId) {
    ...
    private static String resolveLabel(Identifier typeId) {
     ...
     */
    private static String variantSuffix(Identifier typeId, ItemStack icon) {
        try {
            Identifier iconId = Registries.ITEM.getId(icon.getItem());
