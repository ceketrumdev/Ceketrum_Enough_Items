...
public class CeiSearchHelp {
    ...
    public void renderButton(GuiGraphicsExtractor context, int x, int y,
        ...
        context.outline(x, y, BUTTON_W, BAR_H, GuiConstants.BORDER_COLOR);
        String q = "?";
        context.text(textRenderer, Component.literal(q),
    ...
    public void renderOverlay(GuiGraphicsExtractor context, net.minecraft.client.gui.Font textRenderer,
                              double mouseX, double mouseY) {
        if (helpVisible) {
            ...
            context.outline(x, y, w + 10, h, GuiConstants.BORDER_COLOR);
            int ly = y + 4;
            for (int i = 0; i < lines.size(); i++) {
                context.text(textRenderer, Component.literal(lines.get(i)), x + 5, ly,
        ...
        context.outline(popX, popY, popW, h, GuiConstants.BORDER_COLOR);
        int ly = popY + 2;
        for (String id : shown) {
            ...
            context.text(textRenderer, Component.literal(id), popX + 4, ly + 1,
