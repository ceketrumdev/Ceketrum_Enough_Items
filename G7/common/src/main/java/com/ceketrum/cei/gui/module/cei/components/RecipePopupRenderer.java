...
public class RecipePopupRenderer {
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY, ItemStack stack,
        ...
        context.outline(startX, startY, GuiConstants.POPUP_WIDTH, popupHeight, popupBorderColor);
        ...
        context.text(textRenderer, Component.literal(truncatedName).withStyle(ChatFormatting.GOLD), 
