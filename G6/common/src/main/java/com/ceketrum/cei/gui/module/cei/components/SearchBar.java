...
public class SearchBar {
     ...
     */
    public void render(GuiGraphics context, int x, int y, int width, net.minecraft.client.gui.Font textRenderer) {
        ...
        context.renderOutline(x, y, width, SEARCH_BAR_HEIGHT, isFocused ? 0xFFFFFFFF : 0xFF808080);
        ...
        context.drawString(textRenderer, Component.literal(displayText), textX, textY, 0xFFFFFFFF, false);
