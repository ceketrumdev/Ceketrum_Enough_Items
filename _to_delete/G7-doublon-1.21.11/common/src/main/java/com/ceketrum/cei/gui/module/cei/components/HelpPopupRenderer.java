...
public class HelpPopupRenderer {
     ...
     */
    public void render(Object context, int screenWidth, int screenHeight, 
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.fill(context, popupX + 3, popupY + 3, popupX + POPUP_WIDTH + 3, popupY + POPUP_HEIGHT + 3, 
                    shadowAlpha << 24);
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.renderOutline(context, popupX, popupY, POPUP_WIDTH, POPUP_HEIGHT, borderColor);
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.drawString(context, textRenderer, Component.literal(title).withStyle(ChatFormatting.BOLD), 
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.drawString(context, textRenderer, Component.literal(helpText), textX, textY, textColor, false);
        if (!helpText2.isEmpty()) {
            textX = popupX + (POPUP_WIDTH - textRenderer.width(helpText2)) / 2;
            com.ceketrum.cei.gui.util.CeiGraphics.drawString(context, textRenderer, Component.literal(helpText2), textX, textY + 12, textColor, false);
        }
        
        int closeButtonSize = 12;
        int closeButtonX = popupX + POPUP_WIDTH - closeButtonSize - 5;
        int closeButtonY = popupY + 5;
        com.ceketrum.cei.gui.util.CeiGraphics.fill(context, closeButtonX, closeButtonY, closeButtonX + closeButtonSize, closeButtonY + closeButtonSize, 
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.drawString(context, textRenderer, Component.literal(closeSymbol), symbolX, symbolY, textColor, false);
    }
