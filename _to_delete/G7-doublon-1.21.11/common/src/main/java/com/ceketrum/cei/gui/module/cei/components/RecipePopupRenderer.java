...
public class RecipePopupRenderer {
    ...
    public void render(Object context, int mouseX, int mouseY, ItemStack stack,
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.fill(context, startX + shadowOffset, startY + shadowOffset, 
                     startX + GuiConstants.POPUP_WIDTH + shadowOffset, startY + popupHeight + shadowOffset, 
                     shadowAlpha << 24);
        
        int popupBgColor = bgAlpha << 24 | 0x121212;
        ...
        com.ceketrum.cei.gui.util.CeiGraphics.renderOutline(context, startX, startY, GuiConstants.POPUP_WIDTH, popupHeight, popupBorderColor);
        ...
        int itemNameColor = (textAlpha << 24) | 0x00FFFFFF;
        com.ceketrum.cei.gui.util.CeiGraphics.drawString(context, textRenderer, Component.literal(truncatedName).withStyle(ChatFormatting.GOLD), 
                        startX + (GuiConstants.POPUP_WIDTH - itemNameWidth) / 2, startY + 8, itemNameColor, false);
        int separatorColor = borderAlpha << 24 | 0x2e2e2e;
        com.ceketrum.cei.gui.util.CeiGraphics.fill(context, startX + 10, startY + 20, startX + GuiConstants.POPUP_WIDTH - 10, startY + 21, separatorColor);
        ...
        if (hasAnyStats) {
            if (!itemDescription.isEmpty()) {
                currentY += 4;
                com.ceketrum.cei.gui.util.CeiGraphics.fill(context, startX + 10, currentY, startX + GuiConstants.POPUP_WIDTH - 10, currentY + 1, separatorColor);
                currentY += 6;
            } else {
                currentY += 2;
            }
