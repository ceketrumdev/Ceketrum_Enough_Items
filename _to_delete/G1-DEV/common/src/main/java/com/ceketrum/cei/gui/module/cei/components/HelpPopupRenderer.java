...
public class HelpPopupRenderer {
    ...
    public void render(DrawContext context, int screenWidth, int screenHeight, 
        ...
        context.drawBorder(popupX, popupY, POPUP_WIDTH, POPUP_HEIGHT, borderColor);
        ...
        int titleX = popupX + (POPUP_WIDTH - textRenderer.getWidth(title)) / 2;
        ...
        int textY = popupY + 25;
        int textX = popupX + (POPUP_WIDTH - textRenderer.getWidth(helpText)) / 2;
        context.drawText(textRenderer, Text.literal(helpText), textX, textY, textColor, false);
        if (!helpText2.isEmpty()) {
            textX = popupX + (POPUP_WIDTH - textRenderer.getWidth(helpText2)) / 2;
