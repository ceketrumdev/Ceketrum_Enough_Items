 ...
 * produisent ce modele, et le rendu le dessine. La grille n'est plus supposee
 * 3x3 -- ses dimensions font partie de la donnee, ce qui permet d'afficher
 * correctement les recettes moddees qui sortent du format vanilla.
 */
