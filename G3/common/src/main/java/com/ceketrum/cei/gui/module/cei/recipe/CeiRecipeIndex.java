...
public final class CeiRecipeIndex {
    ...
    public static synchronized boolean buildStep(Minecraft client, long budgetNanos) {
        ...
        if (pending == null || pendingFrom != owner) {
            ...
            all.addAll(client.level.getRecipeManager().getRecipes());
            pending = all;
            pendingFrom = owner;
            cursor = 0;
        }
    ...
    private static void indexOne(net.minecraft.world.item.crafting.RecipeHolder<?> entry, net.minecraft.core.RegistryAccess registries) {
