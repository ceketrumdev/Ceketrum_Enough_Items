...
public class StonecutterRecipeRenderer implements IRecipeRenderer {
     ...
     */
    private int drawStonecutterBlock(GuiGraphics context, int startX, int startY, 
        ...
        ItemStack output = recipe.getResultItem(dynamicRegistryManager);
        context.renderItem(output, arrowStartX + arrowLength + arrowHeadSize + 6, startY);
